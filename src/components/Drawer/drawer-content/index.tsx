    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                <Link href="https://nirvanaswap.xyz" target="_blank">
                    {/* <img alt="" src={WonderlandIcon} /> */}
                </Link>

                {address && (
                    <div className="wallet-link">
                        <Link href={`https://explorer.kcc.io/en/address/${address}`} target="_blank">
                            <p>{shorten(address)}</p>
                        </Link>
                    </div>
                )}
            ...
            <div className="dapp-menu-doc-link">
                <Link href="https://docs.nirvanaswap.xyz/" target="_blank">
                    <img alt="" src={DocsIcon} />
                    <p>Docs</p>
                </Link>
                <Link href="https://legacy.nirvanaswap.xyz/" target="_blank">
                    <p>Legacy website</p>
                </Link>
            </div>
            <Social />
